    ...
    <Grid container>
        ...
        <Hidden smDown>
          ...
          >
            ...
            <Grid item className={classes.heroCardSubtitle}>
              ...
              digital products user-friendly and handicap accessible while
              providing an overall great experience is my goal.
            </Grid>

            <Grid
              item
              className={classes.heroButtonContainer}
              onTimeUpdate={window.scrollTo(0, 0)}
              component={Link}
              to="/projects"
            >
      ...
      <Hidden mdUp>
        ...
        >
          ...
          <Grid item className={classes.heroCardSubtitle}>
            I'm a passionate Front-End developer who loves to create, design and
            develop beautiful websites and web applications. Making these
            digital products user-friendly and handicap accessible while
            providing an overall great experience is my goal.
          </Grid>
                ...
                >
                  ...
                  >
                    ...
                    <Grid item className={classes.projectSubtitle}>
                      ...
                      Design that allows Arch to focus on creating exceptional
      ...
      <Grid item container className={classes.aboutContainer}>
        ...
        >
          ...
          <Grid
            ...
            style={{ color: "black" }}
          >
            <Grid item className={classes.aboutTextTitle}>
              About me
            </Grid>
            <Grid item className={classes.aboutTextDetails}>
              Im a Junior Front-End Developer that focuses on writing accessible
              HTML, using modern CSS practices, and writing clean JavaScript.
              When writing JavaScript code, I mostly use React, but I can adapt
              to whatever tools are required. Im based in Knoxville, TN but im
              happy working remotely and have experience working in remote
              teams. When I don't have my face buried in the computer screen,
              I'm enjoying the outdoor scenery, playing video games, catching up
              on all of my TV shows, and enjoy eating at different restaurants.
              I believe in pursuing your dreams until you have turned them into
              reality. I've made many sacrifices to get where I am in life and I
              intend to go even further beyond my capability.
            </Grid>

            <Grid item className={classes.aboutTextButtonContainer}>
              <Button
                onTimeUpdate={window.scrollTo(0, 0)}
                className={classes.aboutTextButton}
                variant="outlined"
                component={Link}
                to="/projects"
              >
